...
const cardVariants = cva(
  "rounded-lg border border-border/60 bg-card text-card-foreground shadow-[var(--shadow-sm)] transition-[box-shadow,border-color] duration-normal",
  {
    variants: {
      variant: {
        default: "hover:shadow-[var(--shadow-md)] hover:border-border/80",
        interactive:
          "hover:shadow-[var(--shadow-md)] hover:-translate-y-0.5 hover:border-primary/20 transition-all duration-normal",
        "glass-dark":
